...
public class QuoteCursorAdapter extends CursorRecyclerViewAdapter<QuoteCursorAdapter.ViewHolder>
  ...
  public void onBindViewHolder(final ViewHolder viewHolder, final Cursor cursor){
    ...
    viewHolder.bidPrice.setContentDescription(mContext.getString(R.string.desc_bid_price, bidPrice));
    ...
    if (Utils.showPercent){
      ...
      viewHolder.change.setContentDescription(mContext.getString(R.string.desc_percent_change, percentChange));
    } else{
      String change = cursor.getString(cursor.getColumnIndex("change"));
      viewHolder.change.setText(change);
      viewHolder.change.setContentDescription(mContext.getString(R.string.desc_change, change));
    }
  }
